...
<header class="site-navbar" role="banner">
    <!-- Phần header cho trang index1.php -->
    ...
    <nav class="site-navigation text-right text-md-center" role="navigation">
        <div class="container">
            <ul class="site-menu js-clone-nav d-none d-md-block">
                ...
                <li class="has-children">
                    <a href="index1.php?act=about">About</a>
                    <ul class="dropdown">
                        <li><a href="#">Menu One</a></li>
                        <li><a href="#">Menu Two</a></li>
                        <li><a href="#">Menu Three</a></li>
                ...
                <li><a href="index1.php?act=shop">Shop</a></li>
                <li><a href="index1.php?act=contact">Contact</a></li>
            </ul>
        </div>
    </nav>
</header>
        ...
        searchInput.addEventListener("keypress", function(e) {
            if (e.key === "Enter") {
                ...
                if (keyword !== "") {
                    ...
                    window.location.href = "index1.php?act=shop&keyword=" + encodeURIComponent(keyword);
                }
            }
        });
    });
